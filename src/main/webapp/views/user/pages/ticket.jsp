...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/user/pages/ticket.css">
            ...
            <div class="ticket-container">
                        ...
                        <div class="payment-info">
                            <div class="ticket-info-row">
                                ...
                                <div class="ticket-value amount">
                                    <fmt:formatNumber value="${payment.amount}" pattern="#,##0" /> VND
                                </div>
                            </div>
                            ...
                            <div class="ticket-info-row">
                                ...
                                <div class="ticket-value">
                                    <div class="payment-method">
                                        ...
                                        <div class="payment-icon ${payment.paymentMethod.toLowerCase()}">
                                            <c:choose>
                            ...
                            <div class="ticket-info-row">
                                ...
                                <div class="ticket-value">
                                    <fmt:formatDate value="${payment.paymentDate}" pattern="HH:mm dd/MM/yyyy" />
                                </div>
                            </div>
                        </div>
                    </c:if>
                ...
                <div class="ticket-footer no-print">
                    <div class="ticket-actions">
                        ...
                        <a href="${pageContext.request.contextPath}/" class="ticket-btn home">
                            <i class="fas fa-home"></i> Trang chủ
                        </a>
                        
                        <a href="${pageContext.request.contextPath}/user/bookings" class="ticket-btn bookings">
