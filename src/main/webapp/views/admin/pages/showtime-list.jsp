...
<head>
    ...
    <link href="${root}/assets/css/admin/showtime-list.css" rel="stylesheet" />
        ...
        <div class="main-content" style="flex: 1; padding: 20px;">
            <div class="header-title">
                ...
                <div class="user-admin">
                    <i class="fas fa-user-circle"></i> Xin chào, ${sessionScope.currentUser.fullName != null ? sessionScope.currentUser.fullName : 'Admin'}
                </div>
            </div>

            <div class="toolbar">
                <a href="${root}/admin/add-showtime" class="btn-add">
