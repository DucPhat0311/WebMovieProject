...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/homepage_style.css" />
...
<body>
    ...
    <div class="container" style="padding-top: 100px;">
        ...
        <div class="movie-grid" id="content-grid">
            <c:forEach items="${listM}" var="m">
                <div class="movie-card">
                    ...
                    <div class="overlay">
                        <a href="${pageContext.request.contextPath}/movie-detail?id=${m.movieId}" class="buy-btn">
                             ${pageType == 'now' ? 'Mua vé' : 'Chi tiết'}
                        </a>
                    </div>
        ...
        <div style="text-align: center; margin: 30px 0;">
            <button onclick="loadMore()" id="btn-loadMore" class="explore-btn" style="cursor: pointer;">
